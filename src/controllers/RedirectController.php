...
class RedirectController extends Controller
{
    ...
    public function actionIndex()
    {
        ...
        if ($tplController) {
            ...
            // Site-relative path: getFullPath() keeps a site's URI prefix ("en/foo"),
            // which never matches a template path ("foo") on a prefixed site.
            $tplPath = Craft::$app->request->getPathInfo();
        ...
        // prefix-stripped path rather than the full path.
        $match = RedirectPlugin::$plugin->getRedirects()->resolveForUri($request->getPathInfo(), $siteId);
